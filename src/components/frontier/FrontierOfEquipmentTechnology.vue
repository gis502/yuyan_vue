        ...
        <div class="technology-item-content">
          ...
          <div v-if="showCommentInput === index" class="comment-input-wrap">
            <input
              ...
              class="comment-input"
            />
            <button @click="handleCommentSubmit(index)" class="comment-submit">
              提交
            </button>
            <button @click="showCommentInput = -1" class="comment-cancel">
              取消
            </button>
          </div>
        </div>
...
.technology-item-info img.active {
  filter: invert(30%) sepia(90%) saturate(2000%) hue-rotate(345deg)
